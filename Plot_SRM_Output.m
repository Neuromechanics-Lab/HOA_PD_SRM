...
for i = 1:length(participants) %participant loop
    ...
    for ii = 1:length(direcs)
        ...
        for iii = 1:length(mags)
            ...
            title_string = {['mSRM']...
                [sprintf('k_{a}=%1.2g', dataAv.Ag_Gains(1)) ' ' sprintf('k_{v}=%1.2g',dataAv.Ag_Gains(2)) ' ' sprintf('k_{d}=%1.2g',dataAv.Ag_Gains(3))]...
            ...
            title_string = {['hSRM - CoM']...
                [sprintf('k_{a1}=%1.2g', dataAv.Ag_Gains_TotalDual_CoM(1)) ' ' sprintf('k_{v1}=%1.2g',dataAv.Ag_Gains_TotalDual_CoM(2))...
                ' ' sprintf('k_{d1}=%1.2g',dataAv.Ag_Gains_TotalDual_CoM(3))] [' ' sprintf('k_{a2}=%1.2g',dataAv.Ag_Gains_TotalDual_CoM(5))...
                ' ' sprintf('k_{v1}=%1.2g',dataAv.Ag_Gains_TotalDual_CoM(6)) ' ' sprintf('k_{d2}=%1.2g',dataAv.Ag_Gains_TotalDual_CoM(7))]...
