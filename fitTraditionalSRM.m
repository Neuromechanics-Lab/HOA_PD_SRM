...
UB_tmp = UB; % temporary upper bound variable (used later)
...
UB(UB == 0) = UB_tmp(UB == 0);  % if there is a upper bound of 0 specified from handput output reset UB to be what it was originally. 
